...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
	...
	<link rel="icon" href="{{ URL::asset('src/images/favicon.png') }}" type="image/ico" />

    <title>SIAP v2 - @yield('title')</title>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-desktop"></i> <span>SIAP v2</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="{{ URL::asset('src/images/img.jpg') }}" alt="..." class="img-circle profile_img">
              </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ URL::asset('src/images/img.jpg') }}" alt="">John Doe
                  </a>
                  ...
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                    <li class="nav-item">
                      <a class="dropdown-item">
                        <span class="image"><img src="{{ URL::asset('src/images/img.jpg') }}" alt="Profile Image" /></span>
                        <span>
        ...
        <footer>
          <div class="pull-right">
            SIAP - Sistem Informasi Asuransi Perbankan &copy; 2019 - <?=date('Y');?>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
